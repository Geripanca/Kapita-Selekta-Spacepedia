...
const Dataki = () => {
  ...
  const flushData = [
    ...
    },
    {
      ...
      desc: (
        <div>
          <img src="./ilustarasi-tatasurya.jpg" alt="ilustrasi tata surya" className="w-2/4 mx-auto" />
    ...
    },
    {
      ...
      desc: (
        <div>
          <img src="./ilustrasi-matahari.jpg" alt="gambar matahari" className="w-1/4 mx-auto" />
          <div class="bg-black text-sm text-center py-2">
            <p>Image source : Wikipedia</p>
          </div>
          <div className="text-justify">
    ...
    },
    {
      ...
      desc: (
        <div>
          <img src="./ilustrasi-planet.png" alt="gambar planet" className="w-1/4 mx-auto" />
          <div class="bg-black text-sm text-center py-2">
            <p>Image source : Wikipedia</p>
          </div>
          <div className="text-justify">
    ...
    },
    {
      ...
      desc: (
        <div>
          <img src="./ilustrasi-asteroid.jpg" alt="gambar asteroid" className="w-1/3 mx-auto" />
          <div class="bg-black text-sm text-center py-2">
            <p>Image source : Wikipedia</p>
          </div>
          <div className="text-justify">
    ...
    },
    {
      ...
      desc: (
        <div>
          <img src="./ilustrasi-bulan.jpg" alt="gambar bulan" className="w-1/3 mx-auto" />
          <div class="bg-black text-sm text-center py-2">
            <p>Image source : Wikipedia</p>
          </div>
          <div className="text-justify">
    ...
    },
    {
      ...
      desc: (
        <div className="mb-10">
          <img src="./ilustrasi-satelitbuatan.jpg" alt="satelit buatan" className="w-1/4 mx-auto" />
          <div class="bg-black text-sm text-center py-2">
            <p>Image source : Wikipedia</p>
          </div>
          <div className="text-justify">
